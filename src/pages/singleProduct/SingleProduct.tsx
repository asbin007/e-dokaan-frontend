    ...
    <div className="flex flex-col md:flex-row -mx-4">
      ...
      <div className="md:flex-1 px-4">
        ...
        <div className="flex mb-4">
          <div className="mr-4">
            <span className="font-bold text-gray-700 dark:text-gray-300">${product?.productPrice}</span>
            <span className="text-gray-600 dark:text-gray-300">${product?.discount}</span>
          </div>
          <div>
